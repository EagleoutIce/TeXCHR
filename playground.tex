...
\chr{Rule Test}{%
   ...
   % a single rule is a solver too, we just have to compose it with nothing else
   \Compose{\Rule{base-case}{}{{\ifnum\c>0}}{\true}{}}%
...
\chr{Compose Test}{%
   \makelist{chr@constraints}{1,2,3,4}%
   \Compose{%
      \Rule{base-case}{}{{\ifnum\c>4}}{\true}{}%
      \Rule{fun}{{\ifnum\c>2}}{{\ifnum\c>0}}{\true}{\ebody{9}}%
   }%
   \chr@program@get{composite_solver}{chr@constraints}
   \chr@list@log{chr@constraints}%
}
