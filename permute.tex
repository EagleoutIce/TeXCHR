...
% later.... i originally tried fingerprinting but it does not work if a constraint appears multiple times.
% so we accept, for the time being, that the same constraints can be checked multiple times
%
