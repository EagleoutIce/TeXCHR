...
%
% well, i noticed too late that we only need permutations of size n and honestly i am too lazy to change that now
% so what we will do is simply just check the first n elements of the list during processing
% yes, this way we check permutations twice, but this, now, is a FIXME
%
