   ...
   \def\chr@@output{\bgroup
      ...
      \loop
         \ifnum\the\chr@tempcountc<\chr@patterns@length\relax
            ...
            \chr@list@let\c=#2[\the\chr@tempcountc]%
            ...
            % we add the index of the respective constraint
            \expandafter\chr@app\expandafter\chr@match@output\expandafter{\expandafter{\the\chr@tempcountc},}%
            %
      ...
      \ifx\chr@pattern@result\chr@ns
         ...
         \chr@list@to@string\chr@list@out{#2}% the permutation tuple:
         \expandafter\expandafter\expandafter\chr@gapp\expandafter\expandafter\expandafter\chr@match@result\expandafter\expandafter\expandafter{\expandafter\expandafter\expandafter{\expandafter\chr@match@output\expandafter}\expandafter{\chr@list@out},}%
